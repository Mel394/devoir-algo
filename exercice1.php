...
while($budgetinitial >= 0)
{
    ...
    elseif($choix == "D")
    {
        ...
        if($montant <= $budgetinitial)
        {
            ...
            echo "Votre dépense de $montant représente $pourcentage du budget initial.\n";
        }

    }
  
     echo "Votre budget est maintenant $budgetinitial.\n";
    if($budgetinitial <= 0)
    {
        echo "Votre budget est nul ou négatif. Le programme est arrêté.\n";
    }
